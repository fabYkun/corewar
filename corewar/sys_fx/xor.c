/*
** xor.c for xor in /home/borel_d/rendu/CPE_2014_corewar/vm/sys_fx
**
** Made by fabien borel
** Login   <borel_d@epitech.net>
**
** Started on  Sun Apr 13 17:26:44 2014 fabien borel
** Last update Sun Apr 13 18:01:10 2014 fabien borel
*/

#include	"../my.h"

int		vm_xor(t_motherbrain *mother, t_current *current)
{
  int		cursor;
  int		val1;
  int		val2;
