/*
** sub.c for sub in /home/borel_d/rendu/CPE_2014_corewar/vm/sys_fx
**
** Made by fabien borel
** Login   <borel_d@epitech.net>
**
** Started on  Sun Apr 13 14:17:51 2014 fabien borel
** Last update Sun Apr 13 19:28:58 2014 fabien borel
*/

#include	"../my.h"

int		vm_sub(t_motherbrain *mother, t_current *current)
{
  int		reg1;
  int		reg2;
  int		reg3;
